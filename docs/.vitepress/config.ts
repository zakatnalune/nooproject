        ...
        sidebar: {
          '/': 
            [
              ...
              { text: 'Chapter 4. Utility Coefficient (UC): The Mathematics of Justice', link: '/chapter-4' },
              { text: 'Chapter 5. Status Dynamics: Flow instead of Stagnation', link: '/chapter-5' },
              { text: 'Chapter 6. The Energy Matrix', link: '/chapter-6' },
              { text: 'Chapter 7. Utilitarianism and "Men Like Gods": The Ethics of the Future', link: '/chapter-7' },
              { text: 'Chapter 8. Identification: Your Phone and Your Face Are Your Passport', link: '/chapter-8' },
              { text: 'Chapter 9. Cities of Choice: Localizing Vice through Humanism', link: '/chapter-9' },
              { text: 'Chapter 10. Noospheregenesis: The Planet as a Unified Home', link: '/chapter-10' },
